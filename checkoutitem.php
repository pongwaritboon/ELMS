...
<head>
    ...
    <title>Checkout Equipments</title>
				...
				<section class="sidebar">
				  ...
				  <ul class="sidebar-menu" data-widget="tree">
					...
					<li class="'.$event_add.'">
						...
						<i class="fa fa-plus"></i> <span>รายการอปกรณ์</span>
						</a>
					</li>
					...
					<li class="">
						<a href="history.php">
						<i class="fa fa-history"></i> <span>ประวัติการยืนอุปกรณ์</span>
						</a>
					</li>
<!--
                   <li class="'.$event_add.'">
            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h2 style="font-size: 30px;" class="box-title">นำออกอุุปกรณ์</h2>
                    </div>
                    <div class="box-body">
...
<!--                                        <th scope="col" width="5%">เวลานัดรับอุปกรณ์</th>-->
                                        <th scope="col" width="5%">รหัสอุปกรณ์</th>
                                        <th scope="col" width="5%">ชื่ออุปกรณ์</th>
                                        <th scope="col" width="10%">วันที่นัดรับอุปกรณ์</th>
...
<!--                                        <th scope="col" width="5%"></th>-->
                                ...
                                <tbody>
                                  <?php
                                    //$sql = "SELECT transactionID, username , itemID, comment , status FROM transaction WHERE status  = 2";
                                    $sql = "SELECT transaction.transactionID,transaction.itemID,transaction.username,transaction.status,transaction.borrowed_date,transaction.user_comment,transaction.pickup_date,device.itemID,device.device_name,userinfo.username,userinfo.firstname,userinfo.surname FROM transaction
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while($row = $result->fetch_assoc()) {
                                           ...
                                           // echo "<td scope='row'>".$i."</td>";
                                            ...
                                            echo "<td scope='row'>".dateThai($row['pickup_date'])."</td>";
